...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-w79es0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-w79es0.containers.anotherwebservice.com/
...
```
git clone git@github.com:darkelectron/container-w79es0.git
cd container-w79es0
```
...
```
docker attach container-w79es0
```
